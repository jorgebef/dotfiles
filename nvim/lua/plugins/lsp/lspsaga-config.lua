...
keymap("n", "<leader>ls", "<cmd>Lspsaga show_cursor_diagnostics<CR>", { silent = true })
...
keymap("n", "[w", function()
	require("lspsaga.diagnostic").goto_prev({ severity = { max = "WARN" } })
end, { silent = true })
keymap("n", "]w", function()
	require("lspsaga.diagnostic").goto_next({ severity = { max = "WARN" } })
end, { silent = true })
-- Only jump to error
keymap("n", "[e", function()
