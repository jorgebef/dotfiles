...
" command! -complete=file -nargs=? Vspli call <SID>split('v', <q-args>)
...
nnoremap <nowait><silent><leader>w :silent write<CR>
nnoremap <nowait><leader>q :q<CR>

nnoremap <silent><leader>3 "syiw<Esc>: let @/ = @s \| set hls<CR>
vnoremap <silent><leader>3 "sy<Esc>: let @/ = @s \| set hls<CR>
